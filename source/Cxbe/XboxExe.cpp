...
// * constructor
// ******************************************************************
XboxExe::XboxExe(Xbe *x_Xbe, DebugMode x_debug_mode, char *x_debug_filename, HWND hwndParent) : Exe()
{
    ConstructorInit();

    printf("XboxExe::XboxExe: Generating Exe file...\n");

    // ******************************************************************
    // * generate pe header
    // ******************************************************************
    {
        printf("XboxExe::XboxExe: Generating PE header...");
    ...
    // ******************************************************************
    {
        printf("XboxExe::XboxExe: Generating Optional Header...");
    ...
    // ******************************************************************
    {
        printf("XboxExe::XboxExe: Generating Section Headers...\n");
        ...
        // ******************************************************************
        {
            ...
            {
                printf("XboxExe::XboxExe: Generating Section Header 0x%.04X...", v);
        ...
        /*{
            ...
            printf("XboxExe::XboxExe: Generating Section Header 0x%.04X (.cxbximp)...", i);
        ...
        // ******************************************************************
        {
            ...
            printf("XboxExe::XboxExe: Generating Section Header 0x%.04X (.cxbxplg)...", i);
    ...
    // ******************************************************************
    {
        printf("XboxExe::XboxExe: Generating Sections...\n");
        ...
        // ******************************************************************
        {
            ...
            for(uint32 v=0;v<x_Xbe->m_Header.dwSections;v++)
            {
                printf("XboxExe::XboxExe: Generating Section 0x%.04X...", v);
        ...
        //    printf("XboxExe::XboxExe: Generating Section 0x%.04X (.cxbximp)...", i);
        ...
        //    printf("XboxExe::XboxExe: Generating Section 0x%.04X (.cxbxplg)...", i);
    ...
    // ******************************************************************
    //{
    //    printf("XboxExe::XboxExe: Hijacking Kernel Imports...\n");
    ...
    //        {
    //            printf("XboxExe::XboxExe: Located Thunk Table in Section 0x%.04X (0x%.08X)...\n", v, kt);
    ...
    //                if(t != -1)
    //                    printf("XboxExe::XboxExe: Thunk %.03d : *0x%.08X := 0x%.08X\n", t, kt + k*4, kt_tbl[k]);
    //            }
    ...
    // ******************************************************************
    {
        printf("XboxExe::XboxExe: Finalizing Exe file...");
